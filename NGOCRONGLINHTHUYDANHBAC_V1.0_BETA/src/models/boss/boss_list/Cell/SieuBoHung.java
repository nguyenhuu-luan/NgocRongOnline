...
public class SieuBoHung extends Boss {
    ...
    private final String text[] = {"Thưa quý vị và các bạn, đây đúng là trận đấu trời long đất lở", "Vượt xa mọi dự đoán của chúng tôi", "Eo ơi toàn thân lão Xên bốc cháy kìa", "Ngọc Rồng Lính Thủy Đánh Bạc Mãi Đỉnh"};
